...
local PresetColor = Color3.fromRGB(140, 44, 224)
...
function lib:Window(text, preset, closebind)
    ...
    local originalSize = Main.Size -- Store the original size of the Main frame
    ...
    MinimizeButton.MouseButton1Click:Connect(function()
        ...
        if isMinimized then
            ...
            Main.Size = originalSize -- Restore the original size
            Title.Visible = true
    ...
    Title.Position = UDim2.new(0.0339285731, 0.1064263314, 0.0564263314, 0)
